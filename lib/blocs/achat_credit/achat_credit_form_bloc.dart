...
class AchatCreditFormBloc extends Object with LoginValidator, InputLengthValidator implements BlocBase {
  ...
  Stream<String> get carrier => _carrierController.stream.transform(carrierValidation);
